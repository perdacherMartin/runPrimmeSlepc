// replace this file with include/slepceps.h
...
PETSC_EXTERN PetscErrorCode EPSPRIMMESetRandomGuesses_PRIMME(EPS eps);
PETSC_EXTERN PetscErrorCode EPSPRIMMESetInitialGuesses_PRIMME(EPS eps, Mat matGuesses);
